...
function ldap_modifyA(ld: PLDAP; dn: PAnsiChar; mods: PLDAPModA): ULONG; cdecl;
{$EXTERNALSYM ldap_modifyW}
//function ldap_modifyW(ld: PLDAP; dn: PWideChar; var mods: PLDAPModW): ULONG; cdecl;
function ldap_modifyW(ld: PLDAP; dn: PWideChar; mods: PLDAPModW): ULONG; cdecl;
...
function ldap_modify_extA(ld: PLDAP; dn: PAnsiChar; mods: PLDAPModA;
  var ServerControls, ClientControls: PLDAPControlA;
...
function ldap_modify_extW(ld: PLDAP; dn: PWideChar; mods: PLDAPModW;
  var ServerControls, ClientControls: PLDAPControlW;
  var MessageNumber: ULONG): ULONG; cdecl;
{$EXTERNALSYM ldap_modify_ext}
//function ldap_modify_ext(ld: PLDAP; dn: PChar; var mods: PLDAPMod;
function ldap_modify_ext(ld: PLDAP; dn: PChar; mods: PLDAPMod;
  var ServerControls, ClientControls: PLDAPControl;
  var MessageNumber: ULONG): ULONG; cdecl;
...
function ldap_addA(ld: PLDAP; dn: PAnsiChar; attrs: PLDAPModA): ULONG; cdecl;
{$EXTERNALSYM ldap_addW}
//function ldap_addW(ld: PLDAP; dn: PWideChar; var attrs: PLDAPModW): ULONG; cdecl;
function ldap_addW(ld: PLDAP; dn: PWideChar; attrs: PLDAPModW): ULONG; cdecl;
...
function ldap_add_sA(ld: PLDAP; dn: PAnsiChar; attrs: PLDAPModA): ULONG; cdecl;
{$EXTERNALSYM ldap_add_sW}
//function ldap_add_sW(ld: PLDAP; dn: PWideChar; var attrs: PLDAPModW): ULONG; cdecl;
function ldap_add_sW(ld: PLDAP; dn: PWideChar; attrs: PLDAPModW): ULONG; cdecl;
