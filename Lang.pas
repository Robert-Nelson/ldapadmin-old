...
const
  { The MAX_STRING_ID is compiler dependent. It can be determined with DRC
    utility, which is used to parse the .DRC Files and retrieve resource ID's
    and the initialization code in TTranslator.Create. If MAX_STRING_ID is too
    smal, the program will issue access violation error in HookLoadResString
    function but debugger will not be able to locate it. The R+ option above
    helps to remedy this situation in a debug modus. }
  MAX_STRING_ID = 736;
  LANG_EXT      = 'llf';
...
uses {$IFDEF VER130}ComConst,{$ENDIF}{$IFDEF VER_D6H} RTLConsts, ComConst,
     WinHelpViewer, {$ENDIF} Windows, TypInfo, Config, SysUtils,
     Consts, Dialogs, Constant, OleConst, ComStrs, jconsts, Graphics,
     ComCtrls, ExtCtrls, SysConst, StdCtrls, Math, Misc, AdObjects
...
begin
  ...
  fStringTable[$10000 - PResStringRec(@SysConst.SOutOfMemory).Identifier] := 453;
  fStringTable[$10000 - PResStringRec(@SysConst.SInOutError).Identifier] := 454;
  fStringTable[$10000 - PResStringRec(@RTLConsts.SFileNotFound).Identifier] := 455;
  fStringTable[$10000 - PResStringRec(@RTLConsts.SInvalidFileName).Identifier] := 456;
  fStringTable[$10000 - PResStringRec(@SysConst.STooManyOpenFiles).Identifier] := 457;
  fStringTable[$10000 - PResStringRec(@SysConst.SAccessDenied).Identifier] := 458;
  fStringTable[$10000 - PResStringRec(@SysConst.SEndOfFile).Identifier] := 459;
  fStringTable[$10000 - PResStringRec(@SysConst.SDiskFull).Identifier] := 460;
  ...
  fStringTable[$10000 - PResStringRec(@OleConst.SNotLicensed).Identifier] := 498;
  fStringTable[$10000 - PResStringRec(@OleConst.sNoRunningObject).Identifier] := 499;
  fStringTable[$10000 - PResStringRec(@SysConst.SInvalidTimeStamp).Identifier] := 503;
  fStringTable[$10000 - PResStringRec(@RTLConsts.SDriveNotFound).Identifier] := 504;
  fStringTable[$10000 - PResStringRec(@RTLConsts.SInvalidCharsInPath).Identifier] := 505;
  fStringTable[$10000 - PResStringRec(@Constant.SAVE_MODIFY_LOG_FILTER).Identifier] := 506;
  fStringTable[$10000 - PResStringRec(@Constant.XML_NO_OPENING_TAG).Identifier] := 507;
  fStringTable[$10000 - PResStringRec(@Constant.cColumnNames).Identifier] := 508;
  fStringTable[$10000 - PResStringRec(@Constant.cLoadBatchFromFile).Identifier] := 509;
  fStringTable[$10000 - PResStringRec(@Constant.cPickQuery).Identifier] := 510;
  fStringTable[$10000 - PResStringRec(@Constant.cPickMembers).Identifier] := 511;
  fStringTable[$10000 - PResStringRec(@Constant.cSaveBatchToFile).Identifier] := 512;
  fStringTable[$10000 - PResStringRec(@Constant.cSaveBatchProtocol).Identifier] := 513;
  fStringTable[$10000 - PResStringRec(@Constant.cSaveSrchResults).Identifier] := 514;
  fStringTable[$10000 - PResStringRec(@Constant.stAssertDecNum).Identifier] := 515;
  fStringTable[$10000 - PResStringRec(@Constant.stArgDecNum).Identifier] := 516;
  fStringTable[$10000 - PResStringRec(@Constant.stCertOpenStoreErr).Identifier] := 517;
  fStringTable[$10000 - PResStringRec(@Constant.stBinaryMatchDn).Identifier] := 518;
  fStringTable[$10000 - PResStringRec(@Constant.stExpectedEndOfStr).Identifier] := 519;
  fStringTable[$10000 - PResStringRec(@Constant.stExpectedAt).Identifier] := 520;
  fStringTable[$10000 - PResStringRec(@Constant.stErrUnaryOp).Identifier] := 521;
  fStringTable[$10000 - PResStringRec(@Constant.stEmptyFile).Identifier] := 522;
  fStringTable[$10000 - PResStringRec(@Constant.stDirNotExists).Identifier] := 523;
  fStringTable[$10000 - PResStringRec(@Constant.stConvErrSambaRid).Identifier] := 524;
  fStringTable[$10000 - PResStringRec(@Constant.stInvalidOperator).Identifier] := 525;
  fStringTable[$10000 - PResStringRec(@Constant.stInvalidChr).Identifier] := 526;
  fStringTable[$10000 - PResStringRec(@Constant.stFileModified).Identifier] := 527;
  fStringTable[$10000 - PResStringRec(@Constant.stExportSuccess).Identifier] := 528;
  fStringTable[$10000 - PResStringRec(@Constant.stExpectedButReceived).Identifier] := 529;
  fStringTable[$10000 - PResStringRec(@Constant.stNoOpeningParenthesis).Identifier] := 530;
  fStringTable[$10000 - PResStringRec(@Constant.stNodeHasChildren).Identifier] := 531;
  fStringTable[$10000 - PResStringRec(@Constant.stNoClosingParenthesis).Identifier] := 532;
  fStringTable[$10000 - PResStringRec(@Constant.stMissingOperator).Identifier] := 533;
  fStringTable[$10000 - PResStringRec(@Constant.stMissingIn).Identifier] := 534;
  fStringTable[$10000 - PResStringRec(@Constant.stRegexError).Identifier] := 535;
  fStringTable[$10000 - PResStringRec(@Constant.stRegCntMatching).Identifier] := 536;
  fStringTable[$10000 - PResStringRec(@Constant.stRegApplying).Identifier] := 537;
  fStringTable[$10000 - PResStringRec(@Constant.stRefUpdateError).Identifier] := 538;
  fStringTable[$10000 - PResStringRec(@Constant.stPathNotFound).Identifier] := 539;
  fStringTable[$10000 - PResStringRec(@Constant.stObjectNotFound).Identifier] := 540;
  fStringTable[$10000 - PResStringRec(@Constant.stNotLABatchFile).Identifier] := 541;
  fStringTable[$10000 - PResStringRec(@OleConst.SBadPropValue).Identifier] := 542;
  fStringTable[$10000 - PResStringRec(@Constant.stUnsuppOperation).Identifier] := 543;
  fStringTable[$10000 - PResStringRec(@Constant.stUnsupportedRule).Identifier] := 544;
  fStringTable[$10000 - PResStringRec(@Constant.stUnexpectedEofStr).Identifier] := 545;
  fStringTable[$10000 - PResStringRec(@Constant.cCurrentConn).Identifier] := 546;
  fStringTable[$10000 - PResStringRec(@Constant.CONNLIST_SAVE_FILTER).Identifier] := 547;
