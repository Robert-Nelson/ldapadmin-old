...
uses Pickup, Input, Misc, Jpeg, Main, Templates, Config, adsie, ActiveDs_TLB,
     AdPrefs, AdAdv, ComObj, ActiveX {$IFDEF VER_XEH}, System.UITypes{$ENDIF};
...
begin
  ...
  try
    ...
    on E: ERRLdap do
      if (esNew in Entry.State) and (E.ErrorCode = LDAP_UNWILLING_TO_PERFORM) and
         (E.ExtErrorCode = ERROR_GEN_FAILURE) then with Entry do
      begin
